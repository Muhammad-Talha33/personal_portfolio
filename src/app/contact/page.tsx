        ...
        <div className="md:flex gap-x-24 clear-left md:mb-16 mb-10">
          <div className=" md:mb-0 mb-4">
            ...
            <div className="flex md:items-center md:justify-start justify-center">
              <button className="w-36 h-12 rounded-full bg-gray-900 transition-all duration-700 hover:bg-black shadow text-white text-center text-base font-semibold leading-6">
                Contact Us
              </button>
            </div>
          </div>
